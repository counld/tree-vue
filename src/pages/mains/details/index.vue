<template>
	<article class="detail-page">
      ...
      <div class="detail-content">
        <el-card body-style="padding: '0px'" v-for="(item,index) in detailItem" :key="index" shadow="hover">
      ...
      <div class="flex justify-content padding-10 align-center">
        ...
        {{item.description}}
			...
			<div class="reset-style" v-html="item.content">
			</div>
		</el-card>
      </div>
    </div>
...
export default {
  ...
  methods: {
    getDetail() {
      ...
      queryApiDetail.call(this, this.id).then((res) => {
